...
class EdgeScoreNet(nn.Module):
    ...
    def __init__(self,input_nc, ndf=64, norm_layer=nn.BatchNorm2d):
        ...
        kw = 70
        padw = 23
        edge_score_conv = nn.Conv2d(1, 1, kernel_size=kw, stride=8, padding=padw)
        edge_score_conv.weight.data.fill_(1)
        edge_score_conv.bias.data.fill_(0)
        
        edge_score_act = nn.LeakyReLU(0.2, True)
        self.edge_score = sequential(edge_score_conv, edge_score_act)
